...
namespace vgui
{
	...
	{
		Vertex_t() {}
		Vertex_t(const Vector2D& pos, const Vector2D& coord = {0, 0})
		{
			m_Position = pos;
			m_TexCoord = coord;
		}
		void Init(const Vector2D& pos, const Vector2D& coord = {0, 0})
		{
			m_Position = pos;
			m_TexCoord = coord;
		}
	...
	public:
		...
		virtual void Unused_9() = 0;
		virtual void Unused_10() = 0;
